...
\usepackage[setpagesize=false,       % leave this task to geometry
            xetex]{hyperref}
\hypersetup{breaklinks=true,         % allow link text to break across lines
            colorlinks=true,         % colorlinks resets pdfborder to 0 0 0
              ...
              citecolor=TyndaleAqua, % for bibliographical citations in text
            hyperfootnotes=false,    % fragile and distracting
            pdfauthor={\professor},
            pdftitle={\coursecode: \coursetitle},
            pdfsubject={Tyndale UC, \semester},
...
\lfoot{\sffamily\scshape\MakeLowercase{\coursetitle}}
\rfoot{\sffamily\scshape\MakeLowercase{\semester~Syllabus | \thepage}}
