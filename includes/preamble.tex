...
\setmainfont[Ligatures=TeX,
             Numbers=OldStyle]{Meta Serif Pro}
\setsansfont[Ligatures=TeX]{Meta Pro}
\newfontfamily{\H}{Meta Hebrew}
...
\renewcommand\normalsize{\fontsize{9.5}{12}\selectfont}% base size
...
\lfoot{\sffamily\scshape\small\MakeLowercase{\ctitle, v\cversion}}
\rfoot{\sffamily\scshape\small\MakeLowercase{\prof\quad\thepage}}
