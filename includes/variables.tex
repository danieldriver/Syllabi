\ProvidesFile{variables.tex}[2025/09/06 v2.3.1 -- Syllabus variables]
...
% in case of fully online, BTh, or undergraduate courses - https://tex.stackexchange.com/a/5896
\newif\ifonline
\newcommand\Int[2]{\ifonline#1\else#2\fi}
\newif\ifbth
\newcommand\bth[2]{\ifbth#1\else#2\fi}
\newif\ifUG
\newcommand\UG[2]{\ifUG#1\else#2\fi}
...
\newcommand\officehours[2][AST Library/MS Teams]{
...
\newcommand\website[2][]{
  \renewcommand\cwebsite{
  \ifthenelse{\isempty{#1}}%
    {\href{https://#2}}% copy url if #1 is empty, else
    {\href{#1}}% use specified url and print #2
  {#2}\xspace}}
\newcommand\cdescription[2][BF 1001; RM 1000 or GTRS 6000]{
