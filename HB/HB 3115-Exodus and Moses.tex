...
\begin{table}[htb]% set to `p' to put the schedule on its own page
  ...
  \begin{tabular}{>{\sessioncount.}r@{ }lllr}% make sure the column config agrees with \setcolumncount
	\toprule
	\sessionskip{\textbf{\S}.}&\textbf{Primary (chapters)}&\textbf{Secondary (pages)}&\textbf{Supplement (author)}&\textbf{Due}\\
	\midrule

%	\unit{One} \\

		&                &                &                &  2 Jul. \\ % or \Int{14}{12} Sep.
		&                &                &                &  3 Jul. \\
		&                &                &                &  4 Jul. \\
		&                &                &                &  5 Jul. \\
	\reminder{First paper is \textbf{due} before midnight on the fourth day of class}{} \\
		&                &                &                &  6 Jul. \\ [1ex]
	...
	\noclass{Term Break (Saturday \& Sunday)}              &         \\ [1ex]
		...
		&                &                &                & 11 Jul. \\
		&                &                &                & 12 Jul. \\
	\reminder{Second paper is \textbf{due} before midnight on the ninth day of class}{} \\
		&                &                &                & 13 Jul. \\ [1ex]

	\reminder{End of Term: Final marks are due for all courses}{27 Jul.} \\
