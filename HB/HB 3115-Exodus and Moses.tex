...
\coursecode[0.8-DRAFT]{HB 3115}% version is 1.0 unless \cmd[1.1]{}
...
Students should also be able to:
	...
	identify, analyze, and explicate suitably short biblical passages, especially from Exodus;
	appreciate, compare, and evaluate traditional religious understandings of the text;
