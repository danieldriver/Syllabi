...
\officehours{Thursdays, 10:30--11:30 \AM}

\semester{Winter 2025}
\meets{Thursdays}% \meets{on}{at}{in}
      {2:00--4:30 \PM}% if online, it prints "From 9:00 AM"
      {Flahiff Room/Teams}% if online, it prints "Brightspace" with link
...
\objectives{% recall Bloom's taxonomy: http://www.celt.iastate.edu/teaching/RevisedBlooms1.html
	...
	reading of biblical books in this language. Students will be given
	support as they continue to develop their ability to learn Hebrew
	independently. Building on their initial study in HB 2201 or
	elsewhere, they will read and translate passages from Genesis (the
	Joseph Story) as they advance in their ability to read the Hebrew
	Bible with confidence and understanding.
...
\begin{thebibliography}{Making Sense}% use the longest item in the bibliography
    ...
    being replaced by the BHQ. The paperback student edition is more
    affordable, but the hardcover is more durable.
	...
	\bibitem[SBLHS2]{sbl2} Collins, Billie Jean, et al.
...
\begin{table}[htbp]% set to `p' to put the schedule on its own page
  ...
  \begin{tabular}{@{}r<{.}@{ }llr}
    ...
    \midrule
    11     & Review Chs. 1--10; Intro to Hebrew Verbs &              &  9 Jan \\
    12     & Vowel Changes in Verbs                   & R11--12      & 16 Jan \\
    13     & Qal Perfects                             & E13, R13     & 23 Jan \\
    14     & Qal Imperfects                           & E14, R14     & 30 Jan \\
    15     & Qal Volitionals                          & E15, R15     &  6 Feb \\
    15     & Qal Volitionals cont’d                   & E15, R15     & 13 Feb \\
	\noclass{Reading Week (AST Open)}                                & 20 Feb \\
    16     & Qal Participles and Infinitives          & E16, R16     & 27 Feb \\
    16     & Self-Directed Study, Review              & E16, R16     &  6 Mar \\
    17     & Qal Waw Consecutives                     & R17          & 13 Mar \\
    18     & Niphal                                   & E18, R18     & 20 Mar \\
    19     & Piel, Pual, and Hithpael                 & E19, R19     & 27 Mar \\
    20--21 & Hiphil and Hophal; Rare Verb Stems       & E20, R20     &  3 Apr \\
%   22     & Verbs with Object Suffixes               & R22--        & 27 Mar \\
%   23     & Irregular Features with Object Suffixes  & E23, R22--23 &  3 Apr \\
...
\begin{enumerate}
 \item
    ...
    prepared to show evidence of their efforts and, if requested, to
    upload scans (PDFs) or photos of any relevant pages from the
    \cite{work} to the course website.
 \item
...
%%%%%%% For online delivery
\item
    Distance students who are taking the course for credit must use a
    ...
    (\href{mailto:daniel.driver@astheology.ns.ca}{daniel.driver@astheology.ns.ca})
    ...
    a PDF (preferred) or take a digital photo of each page.
\end{enumerate}
