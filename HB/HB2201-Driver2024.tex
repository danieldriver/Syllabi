...
\objectives{% recall Bloom's taxonomy: http://www.celt.iastate.edu/teaching/RevisedBlooms1.html
	...
	two-semester series. Students will learn the alphabet, vowels, and
	syllables. They will become familiar with the components that can be
	added to the front and back of Hebrew nouns and adjectives so that
	they can gain a basic understanding of the relationship between
	parsings in electronic sources (Accordance, Logos) and parallel
	translations. The verb system will be introduced briefly with the
	same purpose. Students will read and translate a few passages from
	Genesis so that they can begin to read the Hebrew Bible with
	understanding. They will learn about the limits of what they know,
	too.
	
	Students who wish to continue formal study of Hebrew in HB 2202 will
	be prepared to do so. Others who do not continue in the course
	series will gain skill, confidence, and momentum to progress further
	in the grammar and workbook on their own schedule. A goal in every
	case is to whet the appetite for learning Biblical Hebrew for
	long-term study and use. Language is communal. In the near term,
	therefore, every student will also have the opportunity to become
	part of a community of language learners.
