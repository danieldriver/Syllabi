...
\officehours{Daily, 3:00--4:00 \PM\ Atlantic}

\semester{Summer Term 2020}
\meets{Daily (Mon–Fri)}% \meets{on}{at}{in}
      {2:30--3:00 \PM\ Atlantic}
      {Teams (via AST email)}
...
\objectives{% recall Bloom's taxonomy: http://www.celt.iastate.edu/teaching/RevisedBlooms1.html
	...
	rudiments of biblical Hebrew. The course is designed as the first
	part of a two semester series. This summer, however, it is being
	offered as a stand-alone course with two different options for
	outcomes.

	Option 1: Learn the alphabet, vowels, and syllables with the aim of
	continuing to learn Hebrew on your own. Students will become
	...
	imposing limits. In a past course, the highest achiever overall was
	an auditor.
