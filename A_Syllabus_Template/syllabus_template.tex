...
\newcommand\version      {6.1}
%
\newcommand\professor    {Daniel R. Driver, PhD}
\newcommand\phone        {416.226.6620 x2201}
\newcommand\email        {ddriver@tyndale.ca}
\newcommand\officenumber {Ballyconnor 1088}
\newcommand\officehours  {By appointment only}
%
\newcommand\semester     {Fall 2013}
\newcommand\meeton       {Mondays \& Thursdays}
\newcommand\meetat       {11:30 \textsc{am}--12:50 \textsc{pm}}
\newcommand\meetin       {Ballyconnor 2087}
\newcommand\website      {class.tyndale.ca}
\newcommand\cdescription {% copy from http://tyndale.ca/registrar/calendar
