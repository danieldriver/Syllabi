...
\begin{table}[htbp]% set to `p' to put the schedule on its own page
  ...
  \begin{tabular}{>{\sessioncount.}r@{ }lllr}% make sure the column config agrees with \setcolumncount
	...
	\reminder{A first short paper is \textbf{due} by the end of the fifth week of class}{25 Oct.}    \\ [1ex]% NB I moved this back from wk 6 to wk 5 because of the unusual two week break in F21. Perhaps move back to wk 6 next time.
...
\begin{enumerate}
	...
	the end of the eleventh week.% NB I moved this back from wk 6 to wk 5 because of the unusual two week break in F21. Perhaps move back to wk 6 next time.
