...
%   - Fall 2016
%   - Fall 2017
%   - Fall 2017(Int - online section in parallel to on campus course)
...
\begin{table}[htbp]% set to `p' to put the schedule on its own page
  ...
  \begin{tabular}{>{\sessioncount.}r@{ }lllr}% make sure the column config agrees with \setcolumncount
	...
	\reminder{First paper is \textbf{due} on the sixth day of class}{}             \\
		...
		& 1 \& 2 Samuel        & \HBFB{123--143} & Stephen Chapman       & 24 Oct. \\
	\noclass{Term Break (Monday to Friday)}                              & 31 Oct. \\
		& 1 \& 2 Kings         & \cite[all]{irenaeus} & Robert Alter     &  7 Nov. \\ [1ex]
