...
Library reference section (BS 895 J4 2014).
...
Introductions to the Hebrew Bible/Old Testament abound. I have not assigned one for this class, though I have used a number of them in the past. Students may find one or more the following introductory and companion volumes useful.
...
\begin{thebibliography}{Making Sense}% use the longest item in the bibliography
	...
	3rd ed. Toronto: Oxford University Press, 2019.
...
\begin{table}[htbp]% set to `p' to put the schedule on its own page
  ...
  \begin{tabular}{>{\sessioncount.}r@{ }llr}% make sure the column config agrees with \setcolumncount
	...
	\unit{Law / Torah / Pentateuch} \\
		...
		& Exodus 19--40        & Anderson                 \cite{ga17} & 28 Sep. \\
	    & Leviticus (all if unstated) & Anderson          \cite{ga17} &  5 Oct. \\
		& Deuteronomy          & Heschel \cite{ah51}; Moberly \cite{wm13} & 12 Oct. \\
	\reminder{A first short paper is \textbf{due} by the end of the sixth week of class}{17 Oct.} \\ [1ex]% Have moved btw wks 5 and 6 depending on how holidays (eg, Thanksgiving Monday) impact the schedule

	\unit{Prophets: Former \textit{\&} Latter} \\

		& Joshua; Judges       & Trible                   \cite{pt84} & 19 Oct. \\
	\noclass{Reading Week}                                            & 24--27 Oct. \\
	...
	\unit{Writings: Wisdom \textit{\&} Praise} \\
		...
		& Psalms 1--8; Ecclesiastes & deClaissé-Walford \cite{ndw14}; Fox \cite{mf04} & 30 Nov. \\ [1ex]
