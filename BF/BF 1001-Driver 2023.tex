...
\begin{enumerate}
	...
	reading? What words, phrases, or verses stand out to you from the
	\cite{njps} edition? Pay attention to the things you notice from a
	survey of large sections of the Bible. Stay alert, too, to details that
	strike you from the translation and presentation of the Hebrew
	(Masoretic) text. Make notes as you read. Finally, be prepared to share
	three minutes of highlights with the class. Participation is required.
...
%}
	...
	\begin{enumerate}
		...
		twenty minutes. It should begin with a brief (maximum five-minute)
		overview of the chapter and critical issues raised by it. The
		balance of the time should be spent helping the class discover,
		elaborate, reflect on, test, or otherwise explore the meaning of the
		passage. Vital to success here is the ability to ask good questions
		of the Bible.
		...
		questions and class discussion. The goal here is to report on the
		results of an appreciative but critical inquiry into an example of
		premier biblical interpretation.
		
		\item Students are invited to align their writing with their work
		planning and leading seminars. For example, it is perfectly
		acceptable to lead a discussion on the biblical chapter in which the
		short passage for your exegetical essay appears. It is also
		acceptable to let class discussion spur revisions to your paper, of
		course with the understanding that you credit others appropriately
		for their input.
...
You can access the database while on campus or remotely with your OpenAthens
credentials. Numerous articles by subject-area specialists appear under such
headings as: Ancient Near East; Bible; Early Christianity; Greco-Roman World;
Hebrew Bible; New Testament; Rabbinic Judaism; Second Temple Judaism.
