...
See \autoref{bib} for full bibliographic details. Please give this
material good effort and attention.
...
\begin{table}[htbp]% set to `p' to put the schedule on its own page
  ...
  \begin{tabular}{>{\sessioncount.}r@{ }lllr}% make sure the column config agrees with \setcolumncount
	...
	\reminder{A first short paper is \textbf{due} by the end of the fifth week of class}{21 Oct.}    \\
	\noclass{Reading Week: No classes}                                                   & \Int{24}{} Oct. \\ [1ex]% NB Moved back from wk 6 to wk 5 because of the extra week break for Thanksgiving Monday in F21 (similar in F22). Perhaps move back to wk 6 in future.
	...
	\reminder{A second short paper is \textbf{due} by the end of the tenth week of class}{2 Dec.}    \\ [1ex]% NB Moved back from wk 11 to wk 10 because of the nearness of the last day of class in F22. Perhaps move back to wk 11 in future.
...
\begin{enumerate}
	...
	the end of the tenth week.% NB Moved back from wks 6 and 11 due to unusual scheduling issues. Perhaps return to 6 and 11 in future.
