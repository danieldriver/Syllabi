...
\coursecode[4.1\UG{-UG}{}]{BF 1001\UG{-UG}{}}
...
\meets{Mondays}% \meets{on}{at}{in} - on could be: \Int{Mondays}{Thursdays}
      {10:00 \AM--12:30 \PM}% if online, it prints "From 9:00 AM"
...
\begin{table}[htbp]% set to `p' to put the schedule on its own page
  ...
  \begin{tabular}{>{\sessioncount.}r@{ }lllr}% make sure the column config agrees with \setcolumncount
	\toprule
	\sessionskip{\textbf{\S}.}&\textbf{Primary reading}&\textbf{Focal texts}&\textbf{Secondary}&\textbf{Due}\\
	\midrule
...
%	\reminder{A short paper is \textbf{due} before the \textbf{sixth week} of class}{17 Oct.} \\% Have moved btw wks 5 and 6 depending on how holidays (eg, Thanksgiving Monday) impact the schedule
	...
	\unit{Prophets: Former \textit{\&} Latter} \\
		...
		& \multicolumn{2}{@{}l}{Josh 1--12; 23--24; Judg 1--8; 13--16; 19--21} & \cite[ch. 6--7]{ed19} & 28 Oct. \\
...
%	\reminder{A short paper is \textbf{due} before the \textbf{twelfth week} of class}{5 Dec.} \\% NB Moved back from wk 11 to wk 10 because of the nearness of the last day of class in F22. Perhaps move back to wk 11 in future.
		& \multicolumn{2}{@{}l}{Pss 1--8; 51--60; 89--90; 104--6; 146--50} & \cite[ch. 14]{ed19} &  2 Dec. \\
...
\begin{enumerate}
	...
	to be about \UG{1,000}{1,500} words long, including any footnotes. The
...
%	rest of the day.
	...
	\begin{enumerate}
		...
		selected text. Each paper should interact with at least \UG{four
		(4)}{six (6)} sources or commentators, not counting lectures
